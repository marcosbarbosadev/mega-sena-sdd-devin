...
@Component({
          ...
          @if (isMockMode) {
            <div class="mock-banner">
              ...
              <div class="mock-info">
                ...
                <p>Admin: <code>admin&#64;local.com</code> / <code>123456</code></p>
                <p>Novo usuário: cadastre com qualquer e-mail (ficará pendente)</p>
              </div>
            </div>
          }
        }
  ...
  styles: [`
    ...
    .mock-info strong { display: block; font-size: 0.8125rem; color: #92400e; }
    .mock-info p { margin: 0.25rem 0 0; font-size: 0.75rem; color: #a16207; }
    .mock-info code {
...
export class LoginComponent {
  ...
  readonly isMockMode = environment.useMockAuth;
